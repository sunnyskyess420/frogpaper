...
_MOOD_STRENGTHENING = {
    ...
    "warm":        "warm, inviting, golden-toned",
    "gentle":      "soft, gentle, tender",
    "peaceful":    "serene, peaceful, tranquil",
    "serene":      "calm, serene, undisturbed",
    "hopeful":     "hopeful, uplifting, promising",
    "uplifting":   "uplifting, inspiring, buoyant",
    "joyful":      "joyful, radiant, celebratory",
    "radiant":     "radiant, glowing, luminous",
    "euphoric":    "euphoric, blissful, ecstatic",
    "blissful":    "blissful, euphoric, heavenly",
    ...
    "dreamlike":   "surreal, dreamlike, hazy",
    "bittersweet": "bittersweet, wistful, poignant",
    "wistful":     "wistful, longing, tender",
    "contemplative":"contemplative, reflective, still",
    "solemn":      "solemn, reverent, dignified",
    "reverent":    "reverent, awe-filled, solemn",
    "majestic":    "grand, majestic, awe-inspiring",
    "triumphant":  "victorious, triumphant, celebratory",
    "adventurous": "adventurous, daring, bold",
    # ── Neutral / atmospheric ──
    "mysterious":  "enigmatic, mysterious, shadowed",
    "ethereal":    "otherworldly, ethereal, delicate",
    "mythic":      "mythic, legendary, ancient",
    "surreal":     "surreal, otherworldly, dreamlike",
    # ── Dark / intense ──
    "dark":        "ominous, dark, shadowed",
    "ominous":     "foreboding, ominous, threatening",
    "moody":       "dark, dramatic, moody",
    "menacing":    "menacing, threatening, hostile",
    "foreboding":  "foreboding, ominous, dark",
    "sinister":    "sinister, dark, malevolent",
    "haunting":    "haunting, eerie, lingering",
    "eerie":       "eerie, unsettling, spectral",
    "unsettling":  "unsettling, uncanny, disturbing",
    "tense":       "tense, charged, on-edge",
    "brutal":      "brutal, harsh, unforgiving",
    "wrathful":    "wrathful, furious, raging",
    "apocalyptic": "apocalyptic, devastating, cataclysmic",
    "savage":      "savage, fierce, untamed",
    "lonely":      "lonely, desolate, isolated",
    "melancholic": "melancholic, subdued, emotionally heavy",
    "vulnerable":  "vulnerable, exposed, fragile",
    "raw":         "raw, visceral, unflinching",
    "numb":        "numb, desaturated, hollow",
    "resigned":    "resigned, weary, accepting",
    # ── High energy ──
    ...
    "intense":     "intense, concentrated, powerful",
    "explosive":   "explosive, bursting, dynamic",
    "wild":        "wild, untamed, feral",
    "feverish":    "feverish, intense, burning",
    "frantic":     "frantic, frenzied, urgent",
    "relentless":  "relentless, unstoppable, driving",
    "pulsing":     "pulsing, rhythmic, throbbing",
    "unstoppable": "unstoppable, overwhelming, all-consuming",
    "luxurious":   "opulent, luxurious, elegant",
    "badass":      "bold, badass, confident",
    # ── Compound / aesthetic ──
    "cyberpunk edge":       "neon-lit, gritty, cyberpunk",
    "lo-fi calm":           "muted, lo-fi, relaxed",
    "cottagecore":          "idyllic, pastoral, cottagecore",
    "dark academia":        "scholarly, dark academia, vintage",
    "solarpunk optimism":   "bright, solarpunk, hopeful",
    "vaporwave nostalgia":  "vaporwave, nostalgic, neon-pastel",
    "gothic elegance":      "gothic, elegant, darkly ornate",
    "cosmic awe":           "cosmic, awe-inspiring, vast",
}
...
_MOOD_SUBJECT_FORM = {
    ...
    "luxurious":   "luxurious",
    "badass":      "bold",
    "cyberpunk edge":       "cyberpunk",
    "lo-fi calm":           "lo-fi",
    "cottagecore":          "pastoral",
    "dark academia":        "scholarly",
    "solarpunk optimism":   "solarpunk",
    "vaporwave nostalgia":  "vaporwave",
    "gothic elegance":      "gothic",
    "cosmic awe":           "cosmic",
}
