...
_COMMON = {
    ...
    "text_watermark": "text, watermark, logo, signature, UI elements, borders, frame",
...
_MODE_CONFIG = {
    "stylized": {
        ...
        "quality_lead": "high visual contrast, vivid saturated colours, sharp clean edges",
        "quality_close": "wallpaper-ready composition, no gradients that lose subject definition",
        "negative": (
            f"{_COMMON['glass_objects']}, "
            "low detail, "
            f"{_COMMON['blurry_resolution']}, {_COMMON['anatomy_bad']}, "
            f"{_COMMON['text_watermark']}, "
            "crowded background, busy clutter, duplicate subjects, "
    ...
    "realistic": {
        ...
        "quality_lead": "sharp subject detail, cinematic shallow depth of field, clean background separation",
        "quality_close": "professional photography quality, physically accurate lighting, no plastic sheen",
        "negative": (
    ...
    "product-photo": {
        ...
        "negative": (
            ...
            f"{_COMMON['clutter']}, "
            f"{_COMMON['text_watermark']}, labels, writing, "
            "blurry, soft focus, "
    ...
    "surreal": {
        ...
        "quality_lead": "strange yet readable composition, subject unmistakably recognisable despite surreal context",
        "quality_close": "high imaginative detail, vivid impossible colours, dreamlike but structurally coherent",
        "negative": (
            f"{_COMMON['glass_objects']}, "
            ...
            f"{_HAND_NEGATIVES}, {_FACE_NEGATIVES}, "
            f"{_COMMON['text_watermark']}, "
            "subject unrecognisable, amorphous blob, undefined shape, "
            f"{_COMMON['transparent_materials']}, "
    ...
    "anime": {
        ...
        "quality_lead": "sharp clean outlines, expressive character detail, dynamic pose, studio-quality anime finish",
        "quality_close": "wallpaper-ready 16:9 anime composition, cohesive colour harmony, no rough linework",
        "negative": (
            ...
            f"{_HAND_NEGATIVES}, {_FACE_NEGATIVES}, "
            f"{_COMMON['text_watermark']}, subtitles, "
    ...
    "dark-fantasy": {
        ...
        "quality_lead": "rich shadow detail, high contrast chiaroscuro, brooding colour palette, epic scale",
        "quality_close": "AAA game concept art quality, painterly textures, no flat shading, deep atmospheric perspective",
        "negative": (
    ...
    "painterly": {
        ...
        "quality_lead": "masterful brushstroke detail, warm luminous colour, impressionistic light and shadow",
        "quality_close": "gallery-quality fine art composition, no flat digital look, organic texture throughout",
        "negative": (
            ...
            f"{_HAND_NEGATIVES}, {_FACE_NEGATIVES}, "
            f"{_COMMON['text_watermark']}, frames, "
    ...
    "pixel-art": {
        ...
        "quality_lead": "clean pixel-perfect edges, readable silhouette at all scales, intentional dithering",
        "quality_close": "16-bit or 32-bit era quality, consistent pixel size, strong contrast between foreground and background",
        "negative": (
    ...
    "cinematic": {
        ...
        "quality_lead": "movie-poster depth of field, dramatic lighting ratio, rich shadow and highlight detail",
        "quality_close": "professional colour grading, sharp foreground with atmospheric background, no flat or amateur lighting",
        "negative": (
    ...
    "minimalist": {
        ...
        "quality_lead": "elegant simplicity, strong focal subject with maximum breathing room, no visual noise",
        "quality_close": "poster-quality minimalist layout, crisp edges, cohesive 2-3 colour palette, desktop-icon-safe negative space",
        "negative": (
...
_CREATURE_ANATOMY = {
    ...
    "frog": (
        "Anatomy lock: four limbs, two large eyes, one head, no tail; "
        ...
        "extra limbs, tail on frog, extra eyes, extra heads",
    ),
    "spider": (
    ...
    "eagle": (
        "Anatomy lock: exactly two wings, two legs with talons, one tail, one beak, one head",
        "extra wings, extra legs, extra tails, extra heads, missing wings",
    ),
    "serpent": (
...
def build_prompt(theme: dict, style_mode: str = "stylized", ui_values: dict = None, run_audit: bool = False) -> dict:
    ...
    # ------------------------------------------------------------------
    s9_exclusions = "No text, no watermark, no logo, no UI elements, no borders, no frame"
